...
use-autogenerated-code: func [
	...
	; live-commands/text 
	formatted-name: copy (replace/all name " " "-")
	replace/all live-commands/text "auto-generated-shape" formatted-name
	...
	panel-1: panel 1200x600 158.167.247 [
		...
		auto-code-generation-panel: panel 400x50 247.247.158 [
			...
			button "Use auto-generated code" [
				; print (split points-clicked-on/1 "{")
				; print (length? split points-clicked-on "{")
				name: copy ""
				if (length? points-clicked-on) > 2 [
					name: copy ( ask "Please name the shape: " )
				]
				use-autogenerated-code name ; bring created content to pernament area
